...
const createUI = () => {
  data.forEach((elem) => {
    ...
    newDiv.innerHTML = `<h4>${elem.title}</h4>
    <p>${elem.completed ? "Done" : "Pending"}</p>`;

    // newDiv.innerHTML = document.createElement("h4");
    // const newhaeding = document.createElement("h4");
