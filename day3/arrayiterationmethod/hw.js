...
//   const rec = recipes[i];
//   console.log(rec.name, rec.cuisine);
// }
// const myfun = () => {
...
// const newArr = recipes.filter((elem) => {//filter is use to filter the data
//   const { rating } = elem;
...
const finalArr = newArr.map((elem) => {
  //map reduce the size or data of a array
  const { name, cuisine } = elem;
  return {
    name,
    cuisine,
